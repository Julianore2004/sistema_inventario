    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div id="resultados_ajax2"></div>
          ...
          <div class="form-group">
            <label for="mod_imagen" class="col-sm-3 control-label">URL de la imagen</label>
            <div class="col-sm-8">
              <input type="text" class="form-control" id="mod_imagen" name="mod_imagen" placeholder="URL de la imagen del producto" value="" required>
              <!-- Campo oculto que contiene la imagen actual -->
              <input type="hidden" name="mod_imagen_actual" id="mod_imagen_actual">
              <small class="form-text text-muted">Si no deseas cambiar la imagen, deja este campo vacío.</small>
            </div>
          </div>
